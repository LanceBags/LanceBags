			...
			items = {
				...
				args = {
					categorySortingOrder = {
						name = L['Category View Sorting'],
						desc = L['Select how items should be sorted within each categorized section.'],
						width = 'double',
						type = 'select',
						order = 100,
						arg = 'categorySortingOrder',
						values = {
					...
					oneBagSortingOrder = {
						name = L['One Bag View Sorting'],
						desc = L['Select how items should be sorted in the One Bag view.'],
						width = 'double',
						type = 'select',
						order = 101,
						arg = 'oneBagSortingOrder',
						values = {
							quality = L['By Quality / Item Level'],
							level = L['By Item Level / Quality'],
							name = L['By Name'],
						}
					},
					quality = {
					...
					showSlotCounter = {
						name = L['Show Slot Count'],
						desc = L['Display the number of used/total slots in the bag title.'],
						type = 'toggle',
						order = 250,
					},
					virtualStacks = {
